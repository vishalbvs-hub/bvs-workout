...
const muscleColors = { Chest: "#ef4444", "Upper Chest": "#ef4444", Back: "#3b82f6", "Back/Hamstrings": "#3b82f6", Shoulders: "#f59e0b", "Side Delts": "#f59e0b", "Rear Delts": "#f59e0b", Quads: "#22c55e", "Quads/Glutes": "#22c55e", Legs: "#22c55e", "Quads/Hams": "#22c55e", "Hamstrings/Glutes": "#a855f7", Biceps: "#ec4899", Triceps: "#06b6d4", "Upper Abs": "#f97316", "Lower Abs": "#f97316", "Obliques": "#f97316", "Core": "#f97316", "Abs/Obliques": "#f97316", "Full Core": "#f97316", "Core/Cardio": "#f97316" };
const RPE_OPTIONS = [
...
function CalendarView({ workoutLogs, config, daily, onSaveDaily }) {
  ...
  const gwfd = (ds) => {
    ...
    // Tomorrow: compute next suggestion from config
    const lm = config.lastWorkout || null, la = config.lastAbWorkout || null, lt = config.lastCompletedType || null;
    let nxt = "A";
    if (!lm && !la) nxt = "A";
    else if (lt === "main" || (!lt && lm)) nxt = AB_ORDER[(AB_ORDER.indexOf(la || "Ab3") + 1) % 3];
    else nxt = WORKOUT_ORDER[(WORKOUT_ORDER.indexOf(lm || "D") + 1) % 4];
    return { type: nxt, completed: false };
  };
...
export default function App() {
  ...
  return (
    <div style={{ background: "#030712", minHeight: "100vh", color: "#f8fafc", fontFamily: "'DM Sans', sans-serif", paddingBottom: 80 }}>
      ...
      {view === "calendar" && <CalendarView workoutLogs={workoutLogs} config={config} daily={daily} onSaveDaily={sD} />}
